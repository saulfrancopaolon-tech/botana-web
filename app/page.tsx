...
const menuItems = [
  ...
  { id: 3, name: "Cacahuates Jalapeno", description: "Cacahuates holandeses con el sabor clasico del chile jalapeno.", price: "$15", image: "/images/3.webp", category: "Cacahuates", tags: ["100 gramos"], isPopular: true, isSpicy: true },
